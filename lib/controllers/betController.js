...
exports.getFilteredBets = exports.updateBets = exports.getAllBets = exports.createBet = void 0;
...
function createBet(req, reply) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const bets = yield (0, betRepository_1.createBetRep)(bet); //await prisma.bets.create({ data: bet });
...
function getFilteredBets(req, reply) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.getFilteredBets = getFilteredBets;
